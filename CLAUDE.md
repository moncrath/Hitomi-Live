...
- **Lisensi & aset:** cek lisensi aset/model/dependensi pihak ketiga terhadap **skenario distribusi yang sebenarnya**, bukan cara pakai hari ini — *"boleh dipakai pribadi" ≠ "boleh didistribusikan"*, dan repo publik / rilis / exe yang dibagikan **sudah termasuk distribusi**. Kalau scope proyek berubah privat→publik, **premis lisensi lama gugur** — audit ulang, jangan diwarisi. Repo publik **tanpa file `LICENSE` = hak cipta penuh** (orang tak boleh pakai/ubah/redistribusi); kalau itu bukan maksud user, **angkat sebagai keputusan — jangan memilih lisensi sendiri**. Catat asal-usul tiap aset di Master State (buatan sendiri · dibantu AI · pihak ketiga + lisensinya) dan **jangan overclaim**: "karya orisinal" ≠ "digambar tangan"; gambar yang murni dihasilkan AI mungkin tak memenuhi syarat hak cipta di sebagian yurisdiksi.
