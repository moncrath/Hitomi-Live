...
- **2026-08-01** — **Scope jadi PRIVAT (dipakai user + teman, tak dijual/dipublikasikan).** Konsekuensi: (a) Publication License Live2D tak relevan; (b) kategori **"Expandable Application"** gugur → **sistem skin data-driven boleh tetap terbuka**, tak perlu dikunci ke satu model; (c) model suara/aset pihak ketiga boleh dipakai. Batas yang dijaga: jangan upload model atau exe hasil build ke tempat publik. Ini **membatalkan** konsekuensi arsitektur "kunci ke satu model" di entri lisensi di bawah.
